<template>
  <div>
    ...
    <el-card class="box-card">
      ...
      <el-row :gutter="20">
        <el-col :span="8">
          <el-input v-model="queryInfo.query" placeholder="请输入内容" clearable @clear="userClick">
    ...
    <el-dialog
      title="分配角色"
      :visible.sync="setRoleDiagVisible"
      width="50%"
      @close="setRoleDiagClosed"
    >
      <div>
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="setRoleDiagVisible = false">取 消</el-button>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      editDialogVisible: false, // 是否显示修改用户对话框
      editForm: {},
      editFormRules: {
        email: [
          { required: true, message: '请输入邮箱', trigger: 'blur' },
